---
scope: kbRoot
path_pattern: "technology-matrix.md"
producer: knowledge-base
type: document
description: "Technology stack matrix, language distribution, architecture decision records, and upgrade roadmap for a monorepo codebase."
strictness: strict
---
