...
3. Write to target location: `{{$RP1_KB_ROOT}}/index.md`
...
write_file(f"{{$RP1_KB_ROOT}}/index.md", filled)
```
...
```bash
wc -l {{$RP1_KB_ROOT}}/concept_map.md
wc -l {{$RP1_KB_ROOT}}/architecture.md
wc -l {{$RP1_KB_ROOT}}/modules.md
wc -l {{$RP1_KB_ROOT}}/patterns.md
# For monorepo, also:
wc -l {{$RP1_KB_ROOT}}/dependencies.md
wc -l {{$RP1_KB_ROOT}}/technology-matrix.md
```
