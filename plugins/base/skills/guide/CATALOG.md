...
| `/socratic-duel` | base | Run a bounded, evidence-driven two-agent debate inside a local Markdown document. | `TARGET_PATH`, `PARTICIPANT_NAME`, `MODEL_ID`, `AFK` | Yes | resumable | `TARGET_PATH` |
