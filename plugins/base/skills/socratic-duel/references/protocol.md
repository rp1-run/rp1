# Socratic Duel -- Protocol Detail

Reference companion for `socratic-duel/SKILL.md`. Contains full emit specifications, turn-by-turn procedure, turn structure rules, and prohibitions.
...
3. **debating**
   ...
   - Draft one Markdown turn matching TURN_MARKDOWN and TURN_RULES below. Revise locally until it satisfies the rules.
