...
/**
 * Standalone script to build Copilot CLI artifacts.
 * This is the internal build script used by CI and contributors.
 *
 * Usage:
 *   bun run scripts/build-copilot.ts [options]
 *
 * Options:
 *   -o, --output-dir <dir>   Output directory (default: dist/copilot/)
...
const result = await executeBuild([...args, "--platform", "copilot"], logger)();
