		...
		<article className={cn("markdown-content", className)}>
			...
			<ReactMarkdown
				...
				components={{
					h1: ({ children, ...props }) => (
						<h1
							className="scroll-m-20 text-3xl font-bold tracking-tight mb-4 mt-6 first:mt-0"
							{...props}
						>
							{children}
						</h1>
					...
					h2: ({ children, ...props }) => (
						<h2
							className="scroll-m-20 text-2xl font-semibold tracking-tight mt-8 mb-4 border-b pb-2"
							{...props}
						>
							{children}
						</h2>
					...
					h6: ({ children, ...props }) => (
						<h6
							className="scroll-m-20 text-sm font-semibold tracking-tight mt-4 mb-2 text-muted-foreground"
							{...props}
						>
							{children}
						</h6>
					...
					li: ({ children, className: liClassName, ...props }) => {
						...
						return (
							<li
								className={cn(
									isTaskItem && "list-none ml-0 flex items-start gap-2",
									liClassName,
								)}
								{...props}
							>
					...
					blockquote: ({ children, ...props }) => (
						<blockquote
							className="mt-4 border-l-4 border-terminal-green pl-4 italic text-muted-foreground"
							{...props}
						>
							{children}
						</blockquote>
