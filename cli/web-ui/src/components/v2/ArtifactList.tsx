...
export function ArtifactList({
	...
	const handleKeyDown = (event: React.KeyboardEvent, artifact: Artifact) => {
			...
			{artifacts.map((artifact) => {
				...
				return (
					<li key={artifact.path}>
						{/* biome-ignore lint/a11y/noStaticElementInteractions: conditionally interactive based on onArtifactClick */}
						<div
