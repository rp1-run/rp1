...
export interface InstallAntigravityCommandOptions {
	readonly homeDir?: string;
}

export const createInstallAntigravitySubcommand = (
	commandOptions: InstallAntigravityCommandOptions = {},
): Command =>
...
`,
		...
		.action(async (options, command) => {
			...
			console.log(
				dim("  - Support metadata and dynamic delegation definitions"),
			);
			console.log("");
...
export const installAntigravitySubcommand =
	createInstallAntigravitySubcommand();
