...
Identify which AI coding harness is executing this prompt and assign `CURRENT_HOST` from: `claude-code`, `codex`, `gemini-cli`, `gh-copilot`, `opencode`, `amp`, `unknown`. Default: `opencode`.
