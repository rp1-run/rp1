...
import { validateCommandSyntax, validateAgentSyntax, validateSkillSyntax } from "../../build/validator.js";
import { expectRight } from "../helpers/index.js";
import type { OpenCodeCommand, OpenCodeAgent, OpenCodeSkill } from "../../build/models.js";
  ...
  describe("generateManifest", () => {
    test("produces valid JSON with all required fields", () => {
      const json = expectRight(
        generateManifest("test-plugin", "1.0.0", ["cmd1"], ["agent1"], ["skill1"]),
      );
